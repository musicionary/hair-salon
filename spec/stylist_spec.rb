...
describe(Stylist) do
  ...
  describe("#==") do
    it("should be the same stylist if the name and station are the same") do
      test_stylist = Stylist.new({name: "Mary Shelley", station: "1"})
      test_stylist2 = Stylist.new({name: "Mary Shelley", station: "1"})
  ...
  describe("#clients") do
    it("should return the list of cliests for a particular stylist") do
      test_stylist = Stylist.new({name: "Mary Shelley", station: "1"})
      test_stylist.save()
      client1 = Client.new({name: "Joe Watts", next_appointment: "2016-09-09", stylist_id: test_stylist.id(), id: nil})
      client1.save()
      client2 = Client.new({name: "Alison Hill", next_appointment: "2016-09-09", stylist_id: test_stylist.id(), id: nil})
      client2.save()
