...
describe(Client) do
  describe('#name') do
    it("should return the name of the client") do
      test_client = Client.new({name: "Mary Shelley", next_appointment: "2016-09-09 04:05:06", stylist_id: 1})
  ...
  describe("#next_appointment") do
    it("should return the next_appointment of the client") do
      test_client = Client.new({name: "Mary Shelley", next_appointment: "2016-09-09 04:05:06", stylist_id: 1})
      expect(test_client.next_appointment()).to(eq("2016-09-09 04:05:06"))
    end
  end
  ...
  describe("#update") do
    it("should update a client's name and/or station") do
      ...
      test_client.save()
      expect(Client.all()).to(eq([test_client]))
      test_client.update({name: "Bob Ross", next_appointment: "2016-09-09 04:05:06", stylist_id: 1})
